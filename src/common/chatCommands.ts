...
export const CHAT_COMMANDS: readonly ChatCommand[] = [
  ...
  { name: '/get', usage: '<stat> [char]', helpKey: 'cmd.get', gm: true },
  { name: '/set', usage: '<stat> <value> [char]', helpKey: 'cmd.set', gm: true },
  { name: '/getlevel', usage: '[char]', helpKey: 'cmd.getlevel', gm: true },
  { name: '/setlevel', usage: '<level> [char]', helpKey: 'cmd.setlevel', gm: true },
  { name: '/getmoney', usage: '[char]', helpKey: 'cmd.getmoney', gm: true },
  { name: '/setmoney', usage: '<amount> [char]', helpKey: 'cmd.setmoney', gm: true },
  { name: '/getresets', usage: '[char]', helpKey: 'cmd.getresets', gm: true },
  { name: '/setresets', usage: '<count> [char]', helpKey: 'cmd.setresets', gm: true },
  { name: '/getleveluppoints', usage: '[char]', helpKey: 'cmd.getleveluppoints', gm: true },
  { name: '/setleveluppoints', usage: '<points> [char]', helpKey: 'cmd.setleveluppoints', gm: true },
  { name: '/getmasterlevel', usage: '[char]', helpKey: 'cmd.getmasterlevel', gm: true },
  { name: '/setmasterlevel', usage: '<level> [char]', helpKey: 'cmd.setmasterlevel', gm: true },
  { name: '/getmasterleveluppoints', usage: '[char]', helpKey: 'cmd.getmasterleveluppoints', gm: true },
  { name: '/setmasterleveluppoints', usage: '<points> [char]', helpKey: 'cmd.setmasterleveluppoints', gm: true },
  { name: '/item', usage: '<group> <number> [lvl ex sk lu opt anc ancBonuslvl]', helpKey: 'cmd.item', gm: true },
  { name: '/clearinv', usage: '[char]', helpKey: 'cmd.clearinv', gm: true },
  ...
  { name: '/fireworks', usage: '<x> <y>', helpKey: 'cmd.fireworks', gm: true },
  { name: '/xmasfireworks', usage: '<x> <y>', helpKey: 'cmd.xmasfireworks', gm: true },
